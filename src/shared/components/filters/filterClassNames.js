...
const FILTER_SURFACE_CLASS_NAME =
  'relative inline-flex min-h-[38px] items-center overflow-hidden rounded-full border bg-white shadow-[0_10px_24px_rgba(15,23,42,0.06)] transition';
const FILTER_ICON_TRIGGER_CLASS_NAME =
  'relative inline-flex h-[38px] w-[38px] shrink-0 items-center justify-center overflow-hidden rounded-full border bg-white shadow-[0_10px_24px_rgba(15,23,42,0.06)] transition';
const FILTER_PILL_ROW_CLASS_NAME =
  'flex min-h-[38px] items-center gap-2 overflow-x-auto rounded-full border bg-white p-1 shadow-[0_10px_24px_rgba(15,23,42,0.06)] [scrollbar-width:thin]';
...
const FILTER_POPOVER_CLASS_NAME =
  'z-20 mt-2 grid w-full gap-3 rounded-2xl border bg-white p-3 shadow-[0_20px_40px_rgba(15,23,42,0.14)] sm:absolute sm:left-0 sm:top-[calc(100%+10px)] sm:mt-0 sm:min-w-[280px]';
const FILTER_DATE_RANGE_POPOVER_CLASS_NAME =
  'z-20 mt-2 grid w-full gap-3 rounded-[18px] border bg-white p-3 shadow-[0_20px_40px_rgba(15,23,42,0.14)] sm:absolute sm:left-0 sm:top-[calc(100%+10px)] sm:mt-0 sm:w-[560px] sm:max-w-[calc(100vw-24px)]';
const FILTER_DATE_FIELD_CLASS_NAME =
  'h-[36px] rounded-xl border bg-white px-3 text-[12px] font-medium text-slate-800 outline-none transition';
const FILTER_SCOPE_SELECT_CLASS_NAME =
  'h-[38px] w-[78px] shrink-0 appearance-none border-0 bg-slate-50 pl-2.5 pr-6 text-[10px] font-semibold uppercase tracking-[0.05em] outline-none';
const FILTER_SEARCH_BUTTON_CLASS_NAME =
  'my-1 mr-1 inline-flex h-[30px] w-[30px] shrink-0 items-center justify-center rounded-full border border-transparent transition focus-visible:outline-none';
...
const FILTER_TONES = {
  sky: {
    ...
    pillActive: 'border-sky-300 bg-sky-50 font-bold text-sky-700',
  ...
  amber: {
    ...
    icon: 'text-amber-500',
    field:
      'border-slate-200 focus-within:border-amber-300 focus-within:ring-4 focus-within:ring-amber-100',
    ...
    pillActive: 'border-amber-300 bg-amber-50 font-bold text-amber-700',
  ...
  emerald: {
    ...
    field:
      'border-slate-200 focus-within:border-emerald-300 focus-within:ring-4 focus-within:ring-emerald-100',
    ...
    pillActive: 'border-emerald-300 bg-emerald-50 font-bold text-emerald-700',
  ...
  violet: {
    ...
    field:
      'border-slate-200 focus-within:border-violet-300 focus-within:ring-4 focus-within:ring-violet-100',
    ...
    pillActive: 'border-violet-300 bg-violet-50 font-bold text-violet-700',
  ...
  slate: {
    ...
    pillIdle:
      'border-slate-200 bg-white text-slate-600 hover:border-slate-300 hover:bg-slate-50 hover:text-slate-700',
    pillActive: 'border-slate-300 bg-slate-100 font-bold text-slate-700',
