    ...
    <MobileAccountLayout>
      ...
      <section className="store-info-section" id="store-terms">
        ...
        <ul className="store-info-list">
          <li><a href={getPublicFileUrl('terms-of-service.html')}>Terms and Conditions</a></li>
          <li id="store-privacy"><a href={getPublicFileUrl('privacy-policy.html')}>Privacy Policy</a></li>
          <li><a href={getPublicFileUrl('data-deletion.html')}>Data Deletion</a></li>
        </ul>
      </section>
      ...
      <section className="store-info-section">
        ...
        <div className="store-info-contact">
          ...
          <p><strong>Phone:</strong> {info.CONTACT}</p>
          {info.SHOP_ADDRESS ? <p><strong>Address:</strong> {info.SHOP_ADDRESS}</p> : null}
          {info.COUNTER_HOURS ? <p><strong>Counter Hours:</strong> {info.COUNTER_HOURS}</p> : null}
          {info.ONLINE_STORE_URL ? (
            <p>
              <strong>Online Store:</strong>{' '}
              <a href={info.ONLINE_STORE_URL} target="_blank" rel="noreferrer">Visit Site</a>
            </p>
          ) : null}
        </div>
