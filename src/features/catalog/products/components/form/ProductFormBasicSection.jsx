      ...
      {!isQuickMode ? (
        ...
        <div className="compact-product-grid">
          ...
          <div className="form-group compact-span-2">
            ...
            />
            {errors.purchase_pack_size && (
              <span className="field-error">{errors.purchase_pack_size}</span>
            )}
          </div>
        </div>
      )}
      ...
      {!isQuickMode && (
        <div className="form-group">
          <div className="description-header">
            ...
            <button
              type="button"
              className="suggest-description-btn"
          ...
          <small className="field-help">
            Description is auto-suggested from product name. You can edit it anytime.
          </small>
      ...
      {!isQuickMode && (
        <div className="form-row">
          <div className="form-group">
            ...
            />
            <small className="field-help">
              Optional format: Parent {'->'} Child. Example: Dove {'->'} Baby Care.
            </small>
          </div>
          ...
          <div className="form-group">
            ...
            />
            <small className="field-help">
              Multiple variants: use comma values, e.g. `250g,500g,1kg`.
            </small>
          </div>
        </div>
      )}
      ...
      {!isQuickMode && (
        <div className="form-row">
          <div className="form-group">
            ...
            />
            <small className="field-help">
              Optional comma values for variants, e.g. `Red,Blue,Green`.
            </small>
          </div>
          ...
          <div className="form-group">
            ...
            <small className="field-help">
              Use Parent {'->'} Child for sub-category. Example: Baby Products {'->'} Haircare.
            </small>
            {errors.category && <span className="field-error">{errors.category}</span>}
          </div>
        </div>
