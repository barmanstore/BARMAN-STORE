            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setReturnFormData((prev) => ({ ...prev, distributor_id: e.target.value }))
                  }
                  required
                >
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setReturnFormData((prev) => ({ ...prev, reference_po: e.target.value }))
                  }
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setReturnFormData((prev) => ({ ...prev, return_type: e.target.value }))
                  }
                >
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setReturnFormData((prev) => ({ ...prev, reason: e.target.value }))
                  }
          ...
          <div className="form-section">
            ...
            <div className="items-list">
              {returnFormData.items.map((item, index) => {
                ...
                const quantityInBase = toBaseQtyForProduct(
                  item.quantity,
                  selectedUom,
                  selectedProduct
                );
                  ...
                  <div key={index} className="item-row">
                    <div className="item-field product">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          handleReturnItemChange(index, 'product_id', e.target.value)
                        }
                      >
                    ...
                    <div className="item-field qty">
                      ...
                      <input
                        ...
                        value={item.quantity}
                        onChange={(e) =>
                          handleReturnItemChange(index, 'quantity', parseFloat(e.target.value))
                        }
                      />
                    </div>
                    ...
                    <div className="item-field price">
                      <label
                        htmlFor={`return-mobile-unit-price-${index}`}
                      >{`Unit Price (per ${baseUnitLabel})`}</label>
                      <input
                        ...
                        onChange={(e) =>
                          handleReturnItemChange(index, 'unit_price', parseFloat(e.target.value))
                        }
                      />
                    </div>
                    ...
                    <button
                      ...
                      onClick={() => handleReturnItemRemove(index)}
                    >
                      <X size={16} />
                    </button>
                  </div>
            ...
            {returnFormData.items.map((item, index) => {
              ...
              return (
                <div key={index} className="item-row">
                  ...
                  <div className="item-field price">
                    <label
                      htmlFor={`return-desktop-unit-price-${index}`}
                    >{`Unit Price (per ${baseUnitLabel})`}</label>
                    <input
