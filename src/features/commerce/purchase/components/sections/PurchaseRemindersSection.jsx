    ...
    return (
      <div className="purchase-insight-novelty">
        <div className="purchase-insight-novelty-head">
          ...
          <span>{totalCount} supplier novelty alert{totalCount === 1 ? '' : 's'}</span>
        </div>
                ...
                <div>
                  ...
                  {entry.has_novelty_alerts ? (
                    <small className="purchase-ops-novelty-inline">
                      ...
                      <span>{Math.max(0, Number(entry?.novelty_summary?.total_count || 0))} novelty alert{Number(entry?.novelty_summary?.total_count || 0) === 1 ? '' : 's'}</span>
                    </small>
                  ) : null}
