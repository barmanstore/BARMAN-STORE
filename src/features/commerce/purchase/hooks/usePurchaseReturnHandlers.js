...
const usePurchaseReturnHandlers = ({
  ...
  }, [returnFormData.items, products, resolvePurchaseUnitForProduct, toNumber, findProductForItem, setReturnFormData]);

  const handleReturnItemRemove = useCallback((index) => {
    setReturnFormData((prev) => ({
      ...prev,
