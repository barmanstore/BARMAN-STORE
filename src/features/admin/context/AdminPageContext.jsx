    ...
    <AdminCoreContext.Provider value={coreValue}>
      <AdminShellContext.Provider value={shellValue}>
        <AdminWorkspaceContext.Provider value={value}>
          <AdminModalContext.Provider value={modalValue}>{children}</AdminModalContext.Provider>
...
export const useAdminCoreContext = () =>
  useRequiredContext(AdminCoreContext, 'useAdminCoreContext');
export const useAdminShellContext = () =>
  useRequiredContext(AdminShellContext, 'useAdminShellContext');
export const useAdminWorkspaceContext = () =>
  useRequiredContext(AdminWorkspaceContext, 'useAdminWorkspaceContext');
export const useAdminModalContext = () =>
  useRequiredContext(AdminModalContext, 'useAdminModalContext');
export const useAdminPageContext = useAdminWorkspaceContext;

export { AdminCoreContext, AdminShellContext, AdminWorkspaceContext, AdminModalContext };
