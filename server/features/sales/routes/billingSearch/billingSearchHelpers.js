const createBillingSearchHelpers = ({ dbAllAsync, dbGetAsync } = {}) => {
  ...
  return {
    getBillingProductSelectColumns,
    enrichRowsWithPurchaseCost,
  };
};

module.exports = { createBillingSearchHelpers };
